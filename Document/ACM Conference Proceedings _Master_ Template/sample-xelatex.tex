...
the NS3 environment. Figure ? shows the topology designed in this project. 
...
\subsection{Data Compression}
 ...
 data compression is introduced. In this project zLib external library was implemented to 
 compress data in pre-link path.   
